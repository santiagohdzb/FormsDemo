...
[assembly:ExportRenderer(typeof(FormsDemo.CameraPage), typeof(FormsDemo.Droid.CameraPage))]
namespace FormsDemo.Droid
{
	...
	public class CameraPage : PageRenderer, TextureView.ISurfaceTextureListener
	{
		...
		private async void TakePhotoButtonTapped (object sender, EventArgs e)
		{
			...
			var navigationPage = new NavigationPage (new DisplayPicturePage (imageBytes)) {
